...
class Scene_Menu < Scene_Base
  ...
  def create_command_window
    ...
    @command_window.set_handler(:online, method(:command_online))
    @command_window.set_handler(:register, method(:command_register))
...
class Window_MenuCommand < Window_Command
  ...
  def draw_item(index)
    ...
    if @list[index][:ext] == :arrow
      draw_arrow(:right, rect.right_border - 8, rect.y, enabled)
    end
