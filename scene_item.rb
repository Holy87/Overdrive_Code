...
module H87Item
  ...
  module Settings
    ...
    WEAPON_DETAILS = [:kind, :states, :elements, :bonus]
    #--------------------------------------------------------------------------
  ...
  def self.default_sell_price(item)
    return eval(Settings::SELLPRICE_FORMULA)
  end
end
...
module Vocab
  ...
  # @return [String]
  #--------------------------------------------------------------------------
  def self.hit;'Mira';end
  def self.eva;'Evasione';end
  def self.cri;'Critici';end
  #--------------------------------------------------------------------------
...
class RPG::BaseItem
  ...
  #--------------------------------------------------------------------------
  def selling_price
    return H87Item.default_sell_price(self) if @sellprice.nil?
    @sellprice
  end
  #--------------------------------------------------------------------------
...
class Window_ItemInfo < Window_DataInfo
  ...
  # @param [Color] color
  #--------------------------------------------------------------------------
  def draw_detail(param, value = nil, icon = 0, height = auto_height, color = normal_color)
  ...
  #--------------------------------------------------------------------------
  def draw_hit; draw_parameter(Vocab.hit, item.hit, true); end
  def draw_wht; draw_parameter(Vocab.hit, item.hit - 95, true); end
  def draw_cri; draw_parameter(Vocab.cri, item.cri, true); end
  def draw_eva; draw_parameter(Vocab.eva, item.eva, true); end
  def draw_atk; draw_parameter(Vocab.atk, item.atk); end
  def draw_spi; draw_parameter(Vocab.spi, item.spi); end
  def draw_def; draw_parameter(Vocab.def, item.def); end
  def draw_agi; draw_parameter(Vocab.agi, item.agi); end
  def draw_odds; draw_parameter(Vocab.odds, item.odds); end
  #--------------------------------------------------------------------------
  ...
  def draw_atk_element
    return if item.element_set.empty?
    item.element_set.each {|element|
      next if element_icon(element).nil?
      draw_detail(Vocab::ITEM_ELEMENT, $data_system.elements[element], element_icon(element))
    }
  end
  #--------------------------------------------------------------------------
