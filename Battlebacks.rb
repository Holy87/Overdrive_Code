...
module H87_BattleBackground
  ...
  ADVANCED_BACKGROUNDS = {
      ...
      :darkspeed =>  [{:pictures => 'dark_bg'},
                      {:pictures => 'velocity1', :move_x => 200, :blend => 1, :opacity => 200},
                      {:pictures => 'velocity1', :move_x => 200, :start_x => -640, :blend => 1, :opacity => 200},
                      {:pictures => 'velocity2', :move_x => 300, :blend => 1, :opacity => 200, :re_x => -158},
                      {:pictures => 'velocity2', :move_x => 300, :start_x => -798, :blend => 1, :opacity => 200, :re_x => -158}],
      ...
      :icecave =>    [{:pictures => 'CavernaGhiaccio'},
                      ...
                      {:pictures => 'icecloudc', :opacity => 200, :move_x => -10},
                      {:pictures => 'icecloud', :opacity => 200, :move_x => 20, :blend => 1}],
