...
class Window_TitleCommand < Window_Command
  ...
  def activate
    @menu_command.activate if @menu_command;
  end

  # Closing sequence for new menu command
  def close
    @menu_command.close if @menu_command;
  end
...
class Scene_Title < Scene_Base
  ...
  def create_new_command
    @new_command = Container_TitleCommand.new(@command_viewport, title_command_list, title_handlers)
    @new_command.select @command_window.index
  ...
  # @return [Array<Method>]
  def title_handlers
    @command_window.handlers
  end

  def title_command_list
    @command_window.list
  end
  ...
  def update_press_start
    @press_start.update;
  end

  # Menu title command update
  def update_title_command
    @new_command.update;
  end
...
class Sprite_TitleButton < Sprite
  ...
  # Font bold
  def font_bold
    Title_Settings::TITLE_BOLD;
  end

  # Font italic
  def font_italic
    Title_Settings::TITLE_ITALIC;
  end

  # Font outline
  def font_outline
    Title_Settings::TITLE_OUTLINE;
  end

  # Font shadow
  def font_shadow
    Title_Settings::TITLE_SHADOW;
  end

  # Use image?
  def use_image?
    Title_Settings::USE_IMAGES;
  end

  # Image graphic name (if use image)
  def image_graphic
    Title_Settings::IMAGE_COMMANDS[@tag];
  end

  # Glow the text?
  def glow?
    Title_Settings::TITLE_GLOWED;
  end
