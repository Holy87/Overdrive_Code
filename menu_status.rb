...
module StatusSettings
  ...
  #--------------------------------------------------------------------------
  STAT_VOCABS = {
      :mhp => ['PV massimi',  'Punti vita massimi. Rappresentano la vita dell\'eroe|ed i danni che può subire'],
      ...
      :atk => ['Attacco',     'La potenza d\'attacco. Influisce sul danno del comando Attacca e le abilità,|e la probabilità di infliggere stati alterati con abilità fisiche'],
  ...
  STATS = {
      :mhp => {:text => 'PV massimi',
               :description => 'Punti vita massimi. Rappresentano la vita dell\'eroe|ed i danni che può subire'},
      :mmp => {:text => 'PM massimi',
      ...
      :atk => {:text => 'Attacco',
               :description => 'La potenza d\'attacco. Influisce sul danno del comando Attacca e le|abilità, nonché la probabilità di infliggere stati alterati con queste.'},
      :def => {:text => 'Difesa',
