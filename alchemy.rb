...
module Alchemy_Core
  ...
  # @param [Array<Symbol>] items_array
  ...
  # @return [Game_Actor]
  def self.alchemist
    $game_actors[Alchemy_Settings::ALCHEMIST_ID]
  end
end
...
module Vocab
  ...
  def self.required_alchemy_mp
    Alchemy_Settings::REQ_MP
  end

  def self.alchemy_start
    Alchemy_Settings::TRANSMUTATION_START
  end

  def self.alchemy_cancel
    Alchemy_Settings::TRANSMUTATION_CANCEL
  end
end
...
module Sound
  ...
  def self.play_forge_item
    RPG::SE.new(Forge_Settings::FORGE_SE_ITEM).play
  end

  def self.play_forge_weapon
    RPG::SE.new(Forge_Settings::FORGE_SE_WEAP).play
  end

  def self.play_forge_armor
    RPG::SE.new(Forge_Settings::FORGE_SE_ARMOR).play
  end

  def self.play_forge_start
    RPG::SE.new(Forge_Settings::FORGE_SE_START).play
  end
end
...
class Alchemy_Product
  ...
  def mp_div
    Alchemy_Settings::MP_DIVISOR
  end

  # restituisce il calcolo del prezzo automatico
  def calc_mp
    mp_div > 0 ? item.price / mp_div : 0
  end
end
