...
module H87_BattleBackground
  ...
  ADVANCED_BACKGROUNDS = {
      ...
      #un plane!
      :grass      =>[ {:pictures => 'Erba'},
                      {:pictures => 'Nuvole3', :move_x => -0.01},
                      {:pictures => 'Nuvole2', :move_x => -0.05},
                      {:pictures => 'Nuvole1', :move_x => -0.07},
                      {:pictures => 'Nuvole3', :move_x => -0.01, :start_x => 640},
                      {:pictures => 'Nuvole2', :move_x => -0.05, :start_x => 640},
                      {:pictures => 'Nuvole1', :move_x => -0.07, :start_x => 640}],
      ...
      :castle_outs=> [{:pictures => 'dark_sky', :move_x => 0.1},
                      {:pictures => 'dark_sky', :move_x => 0.1, :start_x => -640},
                      {:pictures => 'red_cloud1', :move_x => 0.15, :opacity => 50},
                      #{:pictures => 'red_cloud2', :move_x => 20, :opacity => 50},
                      {:pictures => 'red_cloud3', :move_x => 0.30, :opacity => 50},
                      {:pictures => 'red_cloud1', :move_x => 0.15, :opacity => 50, :start_x => -640},
                      #{:pictures => 'red_cloud2', :move_x => 20, :opacity => 50, :start_x => -640},
                      {:pictures => 'red_cloud3', :move_x => 0.30, :opacity => 50, :start_x => -640},
      ...
      :sewers     => [{:pictures => 'sewer_water', :start_x => -35, :wave_amp => 10, :wave_length => 150, :wave_speed => 200},
                      ...
                      {:pictures => %w(zoccola1 zoccola2 zoccola3 zoccola4), :start_y => 148, :start_x => -1000, :move_x => 0.2, :re_x => -2000, :frame_speed => 5},
                      {:pictures => %w(bottle1 bottle2), :start_y => 410, :start_x => 540, :re_x => 100, :move_x => -0.25, :frame_speed => 50}],
      :tower_outs => [{:pictures => 'dark_sky', :move_x => 10},
                      {:pictures => 'dark_sky', :move_x => 10, :start_x => -640},
                      {:pictures => 'dark_cloud1', :move_x => 0.20, :start_y => -300, :re_x => -1368, :start_x => -1368, :opacity => 100},
                      {:pictures => 'dark_cloud1', :move_x => 0.20, :start_y => -300, :start_x => -2736, :re_x => -1368, :opacity => 100},
                      {:pictures => 'dark_cloud2', :move_x => 0.40, :re_x => -160, :start_y => -100, :opacity => 100},
                      {:pictures => 'dark_cloud2', :move_x => 0.40, :re_x => -160, :start_y => -100, :start_x => -800, :opacity => 100},
                      {:pictures => 'tower_ground'},
                      {:pictures => 'dark_cloud3', :move_x => 0.80, :re_x => -160, :start_y => -100, :start_x => -400, :opacity => 100},
                      {:pictures => 'dark_cloud3', :move_x => 0.80, :re_x => -160, :start_y => -100, :start_x => 400, :opacity => 100},
                      {:pictures => 'dark_cloud2', :move_x => 0.40, :re_x => -160, :start_y => 260, :opacity => 100},
                      {:pictures => 'dark_cloud2', :move_x => 0.40, :re_x => -160, :start_y => 260, :start_x => -800, :opacity => 100},
                      {:pictures => 'dark_cloud3', :move_x => 0.80, :re_x => -160, :start_y => 320, :start_x => -400, :opacity => 100},
                      #{:pictures => %w(castle_torch1 castle_torch2 castle_torch3), :frame_speed => 10},
                      {:pictures => 'dark_cloud3', :move_x => 80, :re_x => -160, :start_y => 320, :start_x => 400, :opacity => 100},],
      :snow =>       [{:pictures => 'Neve_Sky'},
                      {:pictures => 'Neve_Cl1', :move_x => -80, :re_x => -1200, :opacity => 255},
                      {:pictures => 'Neve_Cl2', :move_x => -100, :re_x => -1200, :opacity => 200},
                      {:pictures => 'Neve_Cl1', :move_x => -80, :re_x => -1200, :start_x => -1200, :opacity => 255},
                      {:pictures => 'Neve_Cl2', :move_x => -100, :re_x => -1200, :start_x => -1200, :opacity => 200},
                      {:pictures => 'Nuvole3', :move_x => -150},
                      {:pictures => 'Nuvole2', :move_x => -200},
                      {:pictures => 'Nuvole1', :move_x => -300},
                      {:pictures => 'Nuvole3', :move_x => -150, :start_x => 640},
                      {:pictures => 'Nuvole2', :move_x => -200, :start_x => 640},
                      {:pictures => 'Nuvole1', :move_x => -300, :start_x => 640},
                      {:pictures => 'Neve1'}],
      :tower_in =>   [{:pictures => 'Torre'},
                      {:pictures => %w(Torre_t1 Torre_t2 Torre_t3), :frame_speed => 10}],
      :town =>       [{:pictures => 'Town'},
                      {:pictures => 'granny_1', :start_x => 83, :start_y => 123},
                      {:pictures => %w(old_man1 old_man2 old_man1 old_man3), :start_x => 120, :start_y => 127, :frame_speed => 11},
                      {:pictures => %w(sailor_1 sailor_2 sailor_3 sailor_3 sailor_2 sailor_1), :start_x => 254, :start_y => 123, :frame_speed => 15},
                      {:pictures => %w(maid_1 maid_2  maid_3 maid_3 maid_3 maid_3 maid_3), :start_x => 392, :start_y => 106, :frame_speed => 10},
                      {:pictures => %w(merchant_1 merchant_2 merchant_1 merchant_3), :start_x => 603, :start_y => 150, :frame_speed => 8}],
      :havoc_base => [{:pictures => 'Base'},
                      {:pictures => %w(disp1 disp2 disp3 disp4 disp5), :start_y => 120, :start_x => 106, :frame_speed => 3},
                      {:pictures => 'korean_script', :start_x => 406, :start_y => 153, :pulse_speed => 1, :pulse_min => 100, :pulse_max => 250}],
      :darkspeed =>  [{:pictures => 'dark_bg'},
                      {:pictures => 'velocity1', :move_x => 0.2, :blend => 1, :opacity => 200},
                      {:pictures => 'velocity1', :move_x => 0.2, :start_x => -640, :blend => 1, :opacity => 200},
                      {:pictures => 'velocity2', :move_x => 0.3, :blend => 1, :opacity => 200, :re_x => -158},
                      {:pictures => 'velocity2', :move_x => 0.3, :start_x => -798, :blend => 1, :opacity => 200, :re_x => -158}],
      :virtual_r =>  [{:pictures => 'RealV'},
                      {:pictures => 'RealV2', :pulse_speed => 5, :pulse_max => 250, :pulse_min => 20}],
      :lava =>       [{:pictures => 'Lava2'},
                      {:pictures => 'lavalight1', :opacity => 150, :pulse_speed => 1, :pulse_max => 200, :pulse_min => 10, :blend => 1},
                      {:pictures => 'lavalight2', :opacity => 100, :pulse_speed => 1, :pulse_max => 200, :pulse_min => 10, :blend => 1},
                      {:pictures => 'lavalight3', :opacity => 50, :pulse_speed => 1, :pulse_max => 200, :pulse_min => 10, :blend => 1},
                      {:pictures => 'lavalight4', :opacity => 0, :pulse_speed => 1, :pulse_max => 200, :pulse_min => 10, :blend => 1}],
      :icecave =>    [{:pictures => 'CavernaGhiaccio'},
                      {:pictures => 'icelight1', :opacity => 75, :pulse_speed => 1, :pulse_max => 75, :pulse_min => 0, :blend => 1},
                      {:pictures => 'icelight2', :opacity => 50, :pulse_speed => 1, :pulse_max => 75, :pulse_min => 0, :blend => 1},
                      {:pictures => 'icelight3', :opacity => 25, :pulse_speed => 1, :pulse_max => 75, :pulse_min => 0, :blend => 1},
                      {:pictures => 'icelight4', :opacity => 0, :pulse_speed => 1, :pulse_max => 75, :pulse_min => 0, :blend => 1},
                      {:pictures => 'icecloudc', :opacity => 200, :move_x => -0.1},
                      {:pictures => 'icecloud', :opacity => 200, :move_x => 0.2, :blend => 1}],
